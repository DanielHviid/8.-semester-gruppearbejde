...
subjectsAll = list(list(1), list(1,2), list(1,2,3), list(1,2,3), list(1,2,3,4),list(1,2,3,4,5),list(),list(1),list(1,2,3),list(1,2,3),list(1,2,3), list(1,2,3,4),list(1,2,3),list(1,2),list(1,2,3),list(1,2),list(1,2,3,4),list(1,2,3,4),list(1,2,3))


#load data
id100Small <- data.frame(getAllData(subjectsSmall, 100))
id100Large <- data.frame(getAllData(subjectsLarge, 100))
id100All    <- data.frame(getAllData(subjectsAll, 100))
...
save(id100All,file ="DataFrames/id100All.Rda")
